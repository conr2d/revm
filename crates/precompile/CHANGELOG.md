...
## [28.0.0](https://github.com/conr2d/revm/compare/revm-precompile-v27.0.0...revm-precompile-v28.0.0) - 2025-09-29

### Added

- [**breaking**] Remove kzg-rs ([#2909](https://github.com/conr2d/revm/pull/2909))

### Fixed

- racecondition return on install_crypto fn ([#2997](https://github.com/conr2d/revm/pull/2997))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/conr2d/revm/pull/2978))

### Other

- add display for precompileid ([#3018](https://github.com/conr2d/revm/pull/3018))
- Remove libsecp256k1 parity lib ([#2954](https://github.com/conr2d/revm/pull/2954))
- add SECURITY.md ([#2956](https://github.com/conr2d/revm/pull/2956))
- add amsterdam in spec id ([#2934](https://github.com/conr2d/revm/pull/2934))
- cargo update ([#2930](https://github.com/conr2d/revm/pull/2930))
- *(precompile)* add new specific `PrecompileError` variants ([#2907](https://github.com/conr2d/revm/pull/2907))
- add Precompil::into_precompile ([#2913](https://github.com/conr2d/revm/pull/2913))
