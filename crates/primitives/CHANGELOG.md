...
## [21.0.0](https://github.com/conr2d/revm/compare/revm-primitives-v20.2.1...revm-primitives-v21.0.0) - 2025-09-29

### Added

- *(revme)* ef blockchain tests cli ([#2935](https://github.com/conr2d/revm/pull/2935))
...
- *(cleanup)* Remove EIP-7918 related functions and EIP file  ([#2925](https://github.com/conr2d/revm/pull/2925))
